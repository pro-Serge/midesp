...
Параллельно для экспериментов был приобретен оригинальный WiFi модуль Midea MWB-S-WB01. Электрически (распиновка разъема и уровни сигналов) он совместим с разъемом на плате ПММ, но совместимости протоколов нет. Модуль MWB-S-WB01 использует известный протокол, который Midea применяет в кондиционерах и другой технике.
